...
const Dashboard = () => {
    ...
    const totalSales = orders?.reduce((total, current)=>{
        const sales = total + Number(current?.grand_total);
        return sales
    },0);
    const averagevalue = totalSales / orders?.length;

    // MAPPING RECENT OREDERS
    const recentOrders = orders?.slice(0, 10).map((elem, index) => {
        return (
            <tr key={index + 1}>
                <td>
                    <div className="d-flex px-2 py-1">
                        <div className="d-flex flex-column justify-content-center">
                            <h6 className="mb-0 text-sm" onClick={() => setId(elem._id)}>
                ...
                <td className="align-middle">
                    <div className=" text-center px-2 py-1">
                        <div className=" text-center">
                            <span className="text-sm">{elem?.shipping_address?.[0]?.contact_person_name}</span>
                        </div>
                    </div>
                </td>
                <td className="align-middle">
                    <div className=" text-center px-2 py-1">
                        <div className=" text-center">
                            <span className="text-sm">{elem?.customer_id}</span>
                        </div>
                    </div>
                </td>
                <td className="align-middle">
                    <div className=" text-center px-2 py-1">
                        <div className=" text-center">
                            <span className="text-sm">{(new Date(elem?.created_at)).toDateString()}</span>
                        </div>
                    </div>
                </td>
                <td>
                ...
                {/* <td className="align-middle">
                    <div className=" text-center px-2 py-1">
                        ...
                        <ul className="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable" data-popper-placement="bottom-start">
                            <li><a className="dropdown-item border-radius-md" href="#">Edit</a></li>
                            <li><a className="dropdown-item border-radius-md" href="#">Delete</a></li>
                        </ul>
                    </div>
                </td> */}
            </tr>
                                    ...
                                    <div className="col-8">
                                        <div className="numbers">
                                            ...
                                            <h5 className="font-weight-bolder mb-0">
                                                {Number(totalSales?.toFixed(2))?.toLocaleString('en-US', { style: 'currency', currency: 'INR' })}
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <div className="row">
                                    <div className="col-8">
                                        <div className="numbers">
                                            ...
                                            <h5 className="font-weight-bolder mb-0">
                                                {Number(averagevalue?.toFixed(2))?.toLocaleString('en-US', { style: 'currency', currency: 'INR' })}
                                            </h5>
                                        </div>
                                    </div>
                                    <div className="col-4 text-end">
                            ...
                            <div className="card-header pb-0">
                                <div className="row">
                                    <div className="col-12 d-flex justify-content-between">
                                        <h6>Recent orders (last 10 orders)</h6>
