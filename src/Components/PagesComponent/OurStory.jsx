...
const OurStory = () => {
  ...
  // HANDLING ADD STORY DETAILS TO ABOVE STATE
  ...
  useEffect(() => {
    dispatch(fetchStory('ourStory'));
  }, [successMsg]);

  // SELECTING ALL STORIES FROM REDUX STATE
  const story = useSelector(state => storySelector.selectAll(state));

  // CHANGE STORY POPUP STATE
  const [contentStatus, setContentStatus] = useState(false);
  // STORY POPUP DETAILS STATE
            ...
            <div className="g-4">
              <div className="card mb-3">
                <div className="card-body p-md-5">
                  <h4>Our Story Content</h4>
                  <form onSubmit={addContent}>
                    <div className="row">
                      <div className="mb-4">
                        <label htmlFor="form-faq/question" className="form-label">Tab Name</label>
                        <input type="text" name='name' className="form-control" id="form-faq/question" value={content.name} onChange={handleDetails} />
                      </div>
                      <div className="mb-4">
                        <label htmlFor="form-faq/answer" className="form-label">Tab Description</label>
                        {/* <textarea name='description' rows='5' className="form-control" id="form-faq/answer" value={content.description} onChange={handleDetails}>
                        </textarea> */}
      ...
      {contentStatus && <div className="password-popup">
        <div className="rts-newsletter-popup popup popup-large">
          ...
          <div className="newsletter-inner popup-inner">
            <h3 className="newsletter-heading">Story</h3>
            <form onSubmit={updateContent}>
              <div className="input-area">
                <div className="input-div">
                  <input name='name' type="text" value={contentDetails.name} placeholder='Tab Name' onChange={(e) => setContentDetails({ ...contentDetails, name: e.target.value })} required />
                </div>
                <div className="input-div">
