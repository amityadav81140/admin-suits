...
const AddCurrency = () => {
    ...
    const currency = (e) => {
        ...
        const response = UpdateData({ url: 'currency/add', cred: credentials });
        response.then(res => {
            window.scrollTo(0, 0);
            if (res.data.status) {
                setSuccessMsg({
                    ...
                    <div className="col-md-8 mb-5">
                        ...
                        <div className="card">
                            <div className="card-body p-md-5">
                                <div className="mb-5">
                                    <h5 className="mb-0 fs-exact-18">Add Currency</h5>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="mb-4 col-md-6">
                                        ...
                                        <select className="sa-select2 form-select select2-hidden-accessible mb-4" name="code" multiple="" data-select2-id="1" tabIndex="-1" aria-hidden="true" onChange={handleDetails} required>
                                            <option defaultValue={null}>Select Country</option>
                                            {
                                                countries.map((country, index) => {
                                                    return <option key={index + 1} value={country.name}>{country.name}</option>;
                                                })
                                            }
                                        </select>
                                        {/* <input
