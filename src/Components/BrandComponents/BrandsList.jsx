...
import { brandsSelector, fetchBrands, remove } from '../../Apis/Getters/brands';
...
const BrandsList = () => {
            ...
            render: elem => <div className=" text-center px-2 py-1">
                ...
                <ul className="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable" data-popper-placement="bottom-start">
                    <li onClick={() => setId(elem._id)}>
                        <Link className="dropdown-item border-radius-md" to={'/admin/brands/brand/' + elem._id}>Edit</Link>
                    </li>
                    <li onClick={() => {
    ...
    const deleteItem = (id) => {
        ...
        const response = DeleteItem({id: id, url:'brands/delete'});
        response.then(res => {
